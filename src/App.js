...
// Importa React y la clase Component para crear un componente de clase.
 import "./estilos/App.css"; // Importa los estilos del proyecto.
 import empleadosData from "./datos/empleados.js"; 
 ...
 constructor(props) {
  ...
  this.state = { empleados: empleadosData, // Carga la lista de empleados desde el JSON.
 ...
 cambiarEstadoEmpleado = (id) => {
  ...
  empleados: prevState.empleados.map((empleado) => empleado.id === id ? { ...empleado, activo: !empleado.activo } : empleado
  ),
  }));
  }
